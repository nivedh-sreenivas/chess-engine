...
#finding the best move on material basis (min max without recursion)
def findBestMoveMinMaxNoRecursion():
...
#This function kinda work like eval bar. +ve score is good for white. -ve score good for black.
def scoreBoard(gs):
    if gs.checkMate:
        if gs.whiteToMove:
